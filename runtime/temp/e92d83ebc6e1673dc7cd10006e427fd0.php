<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\phpStudy\WWW\ylinmfg\public/../application/index\view\item\index.html";i:1516261301;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	...
	<head>
		...
		<link rel="icon" type="image/png" href="__HOME__/images/favicon.png">
		<link rel="stylesheet" type="text/css" href="__HOME__/css/bootstrap.min.css">
		<link rel="stylesheet" type="text/css" href="__HOME__/css/font-awesome.min.css">
		<link rel="stylesheet" href="__HOME__/css/animate.min.css">
		<link rel="stylesheet" href="__HOME__/css/templatemo-style.css">
		...
		/* .work-title{
			position:absolute;top:0;z-index:2;color:#ffffff;text-align:center;font-size:16px;
		} */
        </style>
	</head>
	...
	<body data-spy="scroll" data-target=".navbar-collapse">
			...
			<div class="container">
				<div class="row">
					<div class="navbar-header">
						...
						<a href="#" class="navbar-brand"><h3>意灵坊</h3></a>
					</div>
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="#pricing" class="smoothScroll">定价</a></li>
		...
		<!-- <section id="home" class="text-center">
		  <div class="templatemo_headerimage">
		    <div class="flexslider">
		      <ul class="slides">
		        <li>
		        	<img src="__HOME__/images/slider/1.jpg" alt="Slide 1">
		        ...
		        <li>
		        	<img src="__HOME__/images/slider/2.jpg" alt="Slide 2">
		        	<div class="slider-caption">
					    <div class="templatemo_homewrapper">
		        ...
		        <li>
		        	<img src="__HOME__/images/slider/3.jpg" alt="Slide 3">
		        	<div class="slider-caption">
					    <div class="templatemo_homewrapper">
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-5 wow fadeInRight" data-wow-delay="2000">
						...
						<div class="col-md-6 col-sm-6 col-xs-6">
							<img src="__HOME__/images/company-img-1.jpg" class="img-responsive" alt="company 1">
						</div>
						<div class="col-md-6 col-sm-6 col-xs-6">
							<img src="__HOME__/images/company-img-2.jpg" class="img-responsive" alt="company 2">
						</div>
						<div class="col-md-6 col-sm-6 col-xs-6">
							<img src="__HOME__/images/company-img-3.jpg" class="img-responsive" alt="company 3">
						</div>
						<div class="col-md-6 col-sm-6 col-xs-6">
							<img src="__HOME__/images/company-img-4.jpg" class="img-responsive" alt="company 4">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="col-md-2"><a href="<?php echo url('Example/index'); ?>">更多>></a></div>
						<div class="col-sm-6 col-md-3 wow fadeInLet" data-wow-delay="2000">
							<div class="team_thumb">
								<img src="__HOME__/images/team-img-1.jpg" class="img-responsive" alt="team">
						...
						<div class="col-sm-6 col-md-3 wow fadeInUp" data-wow-delay="2000">
							<div class="team_thumb">
								<img src="__HOME__/images/team-img-2.jpg" class="img-responsive" alt="team">
									<div class="team_overlay">
										<ul class="social_icon">
											<li><a href="#" class="fa fa-facebook"></a></li>
											<li><a href="#" class="fa fa-twitter"></a></li>
						...
						<div class="col-sm-6 col-md-3 wow fadeInUp" data-wow-delay="2000">
							<div class="team_thumb">
								<img src="__HOME__/images/team-img-3.jpg" class="img-responsive" alt="team">
									<div class="team_overlay">
										<ul class="social_icon">
											<li><a href="#" class="fa fa-facebook"></a></li>
											<li><a href="#" class="fa fa-twitter"></a></li>
						...
						<div class="col-sm-6 col-md-3 wow fadeInRight" data-wow-delay="2000">
							<div class="team_thumb">
								<img src="__HOME__/images/team-img-4.jpg" class="img-responsive" alt="team">
									<div class="team_overlay">
										<ul class="social_icon">
											<li><a href="#" class="fa fa-facebook"></a></li>
											<li><a href="#" class="fa fa-twitter"></a></li>
		...
		<section id="work" class="text-center">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="col-md-2"></div>
						<div class="col-sm-6 col-md-4 wow fadeInLeft item-content" data-wow-delay="2000" style="position:relative;">
							<div class="work_thumb" >
								<img src="__HOME__/images/work-img-1.jpg" class="img-responsive" alt="work">
									<div class="work_overlay">
										<a href="<?php echo url('Item/detail'); ?>"><i class="fa fa-thumbs-o-up"></i></a>
									</div>
                            </div>
                            <div class="work-title">
							   <span>作者:意灵坊</span>
							   <span>《传递灵感创意,呈现智慧与生活》</span> 
                            </div>
						</div>
						<div class="col-sm-6 col-md-4 wow fadeInDown item-content" data-wow-delay="2000">
							<div class="work_thumb">
								<img src="__HOME__/images/work-img-2.jpg" class="img-responsive" alt="work">
									<div class="work_overlay">
						...
						<div class="col-sm-6 col-md-4 wow fadeInRight item-content" data-wow-delay="2000">
							<div class="work_thumb">
								<img src="__HOME__/images/work-img-3.jpg" class="img-responsive" alt="work">
									<div class="work_overlay">
										<a href="#"><i class="fa fa-thumbs-o-up"></i></a>
									</div>
									<div class="work-title">
                        ...
                        <div class="col-sm-6 col-md-4 wow fadeInLeft item-content" data-wow-delay="2000">
							<div class="work_thumb">
								<img src="__HOME__/images/work-img-1.jpg" class="img-responsive" alt="work">
									<div class="work_overlay">
										<a href="#"><i class="fa fa-thumbs-o-up"></i></a>
		...
		<script src="__HOME__/js/jquery.simple-text-rotator.js"></script>
		<script src="__HOME__/js/smoothscroll.js"></script>
		<script src="__HOME__/js/wow.min.js"></script>
		<script src="__HOME__/js/jquery.flexslider.js"></script>
		<script src="__HOME__/js/templatemo-script.js"></script>
		<!-- end javascript -->
	</body>	
</html>