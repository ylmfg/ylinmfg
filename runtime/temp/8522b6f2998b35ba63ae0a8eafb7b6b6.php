<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\phpStudy\WWW\ylinmfg\public/../application/index\view\index\single.html";i:1515467905;s:73:"D:\phpStudy\WWW\ylinmfg\public/../application/index\view\comm\footer.html";i:1511421844;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>产品详细列表-意灵玻艺装饰工坊-专注玻璃艺术和现代装饰画</title>
    ...
    <script src="__JS__/bootstrap-3.3.4.js"></script>
    ...
    <!---- animated-css ---->
    <link href="__CSS__/animate.css" rel="stylesheet" type="text/css" media="all">
            ...
            <nav class="navbar navbar-default">
                ...
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand logo wow fadeInLeft animated" data-wow-delay=".5s">
                        <h1><a href="index.html">意<br>灵<br><span>玻<br>艺</span><br>工<br>坊</a></h1>
                    </div>
                </div>
                ...
                <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav wow fadeInDown animated" data-wow-delay=".5s">
                        <li ><a href="index.html"><span data-hover="Home">返回首页</span></a> </li>
...
<div class="single">
    <div class="container">
        ...
        <div class="single-top">
            <img class="img-responsive wow fadeInUp animated" data-wow-delay=".5s" src="__IMAGES__/bo.jpg" alt="" />
            <div class="lone-line">
                <h4>此产品项目标题</h4>
                <ul class="grid-blog">
        ...
        <div class="comment">
            ...
            <div class="media media-1 wow fadeInUp animated" data-wow-delay=".5s">
                ...
                <div class="media-left">
                    <a href="#">
                        <img src="__IMAGES__/si1.jpg" alt="">
                    </a>
                </div>
                <div class="media-body">
            ...
            <div class="media wow fadeInRight animated" data-wow-delay=".5s">
                ...
                <div class="media-left">
                    <a href="#">
                        <img src="__IMAGES__/si2.jpg" alt="">
                    </a>
                </div>
                <div class="media-body">
        ...
        <div class="leave">
            ...
            <form>
                <div class="single-grid wow fadeInLeft animated" data-wow-delay=".5s">
                    ...
                    <input type="text" value="" placeholder="名字">

                    <input type="text" value="" placeholder="邮箱">


                    <input type="text" value="" placeholder="网站">

                    <textarea value="" placeholder="请添加评论内容"></textarea>
...
<!--}-->
<!--</script>-->
<!--<a href="javascript:goTop();" class="go_top" style=" z-index:9999"><img src="__IMAGES__/to_pup.png"></a>-->
</body>
<style>
    #btn{
